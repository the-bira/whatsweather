(function() {
  ...
  angular.module('ds.clock', [])
    ...
    .directive('dsWidgetClockNight', ['$interval', '$filter',
      function($interval, $filter) {
        return clockNight($interval, $filter);
      }
    ]);

    function clockNight($interval, $filter) {
      return {
        restrict: 'EA',
        scope: {
          gmtOffset: '=gmtOffset',
        ...
        templateUrl: "templates/clocknight.html",
        ...
        link: function(scope, element, attrs) {
          ...
          var digitalFormat = scope.digitalFormat ? scope.digitalFormat : 'HH:mm';
